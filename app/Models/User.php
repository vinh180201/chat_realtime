...
class User extends Authenticatable
{
    ...
    public function receive_connect()
    {
        return $this->hasMany(ReceiveConnect::class, 'user_id');
    }
    public function request_connect()
    {
        return $this->hasMany(ReceiveConnect::class, 'receiver_id');
    }
